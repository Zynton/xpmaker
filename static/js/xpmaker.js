...
// Takes an array of rhythm strings.
// Returns a modified array of rhythm strings,
// stripped of its illegal content, namely
// whatever is not an integer that is a power of two.
...
// Recursive helper function to add_ties.
// Creates the string that will replace the string with the note
// that needs dividing.
// Takes the string it has so far been generating,
// the string that is left to transform,
// the current length in the beat, the length of the note that is
// being modified, and the available time for that note to develop
// without being cut.
